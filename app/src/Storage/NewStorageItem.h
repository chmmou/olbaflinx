 ...
 */
#ifndef OLBAFLINX_APP_NEW_STORAGE_ITEM_H
#define OLBAFLINX_APP_NEW_STORAGE_ITEM_H

#include <QtWidgets/QWidget>

namespace olbaflinx::app::storage {
...
} // namespace olbaflinx::app::storage::pages

#endif //OLBAFLINX_APP_NEW_STORAGE_ITEM_H
